...
- [x] **F1** `SKILL.md`: добавить раздел `§INVARIANTS`:
  ```
...
- [x] **F2** `SKILL.md` Stage 0: документировать обе формы:
  ```
...
- [x] **F3** `SKILL.md` Post-action: исправить путь `runtime/glossary_pending.yaml` → `.wiki/config/glossary_pending.yaml`

- [x] **F4** `SKILL.md` Post-action: обновить последовательность:
  ```
  wiki rebuild
...
- [x] **F5** `SKILL.md` добавить раздел `§FORMATS`:
...
- [x] **F6** `SKILL.md` добавить раздел `§TAXONOMY` (ссылка на систему тегов + таблицы из §TAXONOMY выше)

- [x] **F7** `SKILL.md` обновить шаблон `.create.md` — добавить поля `domain`, `layer` (см. §OBSIDIAN)

- [x] **F8** `SKILL.md` добавить раздел `§OBSIDIAN` (стандарт разметки из §OBSIDIAN выше)

- [x] **F9** `guide.md`: добавить секции для новых команд (`save-proposals`, `delete`), frontmatter, domain/layer, таблицы views
...
- [x] **G1** Создать `templates/idea.md` — шаблон для страниц типа `idea`:
...
- [x] **G2** Создать `templates/pattern.md` — шаблон для страниц типа `pattern`:
...
- [x] **G3** Создать `templates/tool.md` — шаблон для страниц типа `tool`:
...
- [x] **G4** Создать `templates/create-draft.md` — шаблон черновика `.create.md` для LLM Stage 2.  
...
- [x] **G5** Создать `templates/diff-draft.md` — шаблон черновика `.diff.md` для LLM Stage 2:
...
- [x] **G6** `cli.py`: добавить команду `wiki templates` — показывает список шаблонов и их расположение:
  ```
  wiki templates
