"""Staged context builder — Spec_v2 §4.8 (legacy FS implementation).

I-LEGACY-FS-EXCEPTION-1: this module is the authorised home for direct FS reads
after migration_complete() == True.  All other locations MUST route through
ContextRuntime (I-GRAPH-FS-ROOT-1).
"""
